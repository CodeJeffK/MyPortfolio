    ...
    <section id="skills" className="pt-10 pb-24">
      ...
      <div className="md:flex md:justify-between mt-16 gap-32">
        ...
        >
          ...
          <p className="mt-5">
            I currently enjoy working with Node.JS and Express to develop the server-side of my websites.
          </p>
        </motion.div>
        {/* IMAGINATIVE */}
        <motion.div
        ...
        >
          ...
          <p className="mt-5">
            MySQL and MongoDB are what i am familiar with for handling the database layer of my websites.
          </p>
        </motion.div>
      </div>
    </section>
